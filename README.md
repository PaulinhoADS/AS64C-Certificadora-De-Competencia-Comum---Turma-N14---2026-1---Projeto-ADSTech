...
# Projeto de Recurso Educacional Aberto - ADSTech E-commerce

<div align="center">
  <img src="Prototipo/logo_ADSTech.png" alt="Logo ADSTech Hub" width="500"/>
</div>
...
Este projeto está sendo desenvolvido para a disciplina Certificadora de Competência Comum do curso de Análise e Desenvolvimento de Sistemas (ADS). Turma N14 2026/1.
...
**Desenvolvimento Web Front-End (Principal)** e **Desenvolvimento Ágil (Secundária)**.
...
| Elaboração de Roteiros (REA) | 15 | | | X | X |
| Desenvolvimento do E-commerce (Base) | 30 | X | X | | |
| Gravação e Edição de Vídeos | 15 | | | X | X |
