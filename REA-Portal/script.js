 ...
 * Aqui guardamos os textos, títulos e links de vídeo para os interessados em aprender.
 * links da video-aula gravada no YouTube precisam ter o formato "/embed/ID_DO_VIDEO"
 */
const baseDeAulas = {
    'html': {
        titulo: "Módulo 1: O Esqueleto (HTML)",
        texto: `<p>Imagine que você está construindo uma casa. O <strong>HTML</strong> (HyperText Markup Language) 
    ...
    'css': {
        ...
        texto: `<p>Se o HTML é a parede de tijolos, o <strong>CSS</strong> (Cascading Style Sheets) é a tinta, 
    ...
    'js': {
        ...
        texto: `<p><p>Nossa casa já está construída e pintada, mas as luzes não acendem sozinhas, certo? 
