# Histórias de Usuário - ADSTech

Estas histórias descrevem as necessidades dos nossos usuários (alunos iniciantes e o público do projeto de Ensino Lúdico de Lógica de Programação) para guiar o desenvolvimento ágil.
...
| ID | Descrição |
| :--- | :--- |
| **RF01** | Catálogo de Produtos: A plataforma deve exibir uma lista de produtos de tecnologia (ex: mouses, teclados, monitores) com imagem, nome e preço. |
...
| ID | Descrição |
| :--- | :--- |
| **RNF01** | Responsividade: A interface deve ser adaptável para dispositivos móveis e desktops utilizando CSS (Media Queries). |
| **RNF02** | Usabilidade/Acessibilidade: O site deve seguir boas práticas de IHC, incluindo legendas nos vídeos e contraste adequado para leitura. |
| **RNF03** | Desempenho: A página deve carregar rapidamente para garantir uma boa experiência de aprendizado.
| **RNF04** | Disponibilidade: O projeto deve estar hospedado de forma aberta no GitHub Pages para acesso público. |
